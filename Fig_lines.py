...
data_fname='npz/zmDiffu_'+str(yr_st)+'_'+str(yr_end)+'.npz'
if PROCESS_FLAG:
#    yr_num=0
#    for yr in range(yr_st,yr_end+1):
#        if yr_num==0:
...
#for zlev in [300,330,350,360,370,380]
#for zlev in range(4):
cs=axes.plot(lat,(plt_fld[3,:])/1e5,color='k')
#cs=axes.plot(lat,np.log(plt_fld[7,:])/np.log(np.exp(1)),color='green')
...
plt.savefig("/home/cliu/Documents/RESEARCH/2017/DIFFUSIVITY/FIGURES/11_2017/diffu_zm_y.pdf",format='pdf')
plt.show()
