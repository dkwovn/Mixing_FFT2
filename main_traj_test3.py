...
from test3_diffu_class import mw_diffu,dc
...
data_fname='/home/cjliu/data/npz/testDiffuTraj350K_um_DJF_'+str(int(tLag))+'_int_'+str(x_int)+'_'+str(y_int)+'_'+str(yr_st)+'_'+str(yr_end)+'.npz'
